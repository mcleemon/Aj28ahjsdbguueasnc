...
export const ARMOR_DB = [
    ...
    { id: 'wood_armor', name: "Wooden Armor", defense: 60, tier: 1, matReq: 'wood_scraps' },
    { id: 'copper_armor', name: "Copper Armor", defense: 130, tier: 2, matReq: 'copper_ore' },
    { id: 'iron_armor', name: "Iron Armor", defense: 195, tier: 3, matReq: 'iron_ore' },
    { id: 'steel_armor', name: "Steel Armor", defense: 260, tier: 4, matReq: 'coal' },
    { id: 'silver_armor', name: "Silver Armor", defense: 330, tier: 5, matReq: 'silver_ore' },
    { id: 'gold_armor', name: "Golden Armor", defense: 395, tier: 6, matReq: 'gold_ore' },
    { id: 'obsidian_armor', name: "Obsidian Armor", defense: 460, tier: 7, matReq: 'obsidian_shard' },
    { id: 'platinum_armor', name: "Platinum Armor", defense: 530, tier: 8, matReq: 'platinum_ore' },
    { id: 'mithril_armor', name: "Mithril Armor", defense: 595, tier: 9, matReq: 'mithril_ore' },
    { id: 'orichalcum_armor', name: "Orichalcum Armor", defense: 660, tier: 10, matReq: 'orichalcum_ore' },
    { id: 'adamantite_armor', name: "Adamantite Armor", defense: 730, tier: 11, matReq: 'adamantite_ore', extraMats: RECIPE_T11 },
    { id: 'rune_armor', name: "Rune Armor", defense: 795, tier: 12, matReq: 'rune_essence', extraMats: RECIPE_T12 },
    { id: 'dragon_armor', name: "Dragon Armor", defense: 860, tier: 13, matReq: 'dragon_scale', extraMats: RECIPE_T13 },
    { id: 'void_armor', name: "Void Armor", defense: 920, tier: 14, matReq: 'void_dust', extraMats: RECIPE_T14 },
    { id: 'celestial_armor', name: "Celestial Armor", defense: 980, tier: 15, matReq: 'celestial_shard', extraMats: RECIPE_T15 }
];